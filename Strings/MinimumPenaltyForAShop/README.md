...
Note that if a shop closes at the j-th hour, it means the shop is closed at hour `j`.
...
Closing the shop at the 2nd or 4th hour gives a minimum penalty. Since 2 is earlier, the optimal closing time is 2.
